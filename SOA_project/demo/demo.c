...
void creation_test() {
   ...
   get_args args4 = {.key = 300, .perm = ANY};
...
void opening_test() {
   ...
   get_args args3 = {.key = 75, .perm = ANY};
   pthread_create(&tid2, NULL, open_service, (void *) &args3);

   get_args args4 = {.key = 100, .perm = ANY};
...
void msg_test() {
   ...
   exchange_args args1 = {.tag = 24, .level = 6, .buff = buff1, .size = 32};
   pthread_create(&tid0, NULL, receive_message, (void *) &args1);

   exchange_args args2 = {.tag = 57, .level = 12, .buff = buff2, .size = 32};
   pthread_create(&tid1, NULL, receive_message, (void *) &args2);

   exchange_args args3 = {.tag = 49, .level = 2, .buff = buff3, .size = 32};
   pthread_create(&tid2, NULL, receive_message, (void *) &args3);

   exchange_args args4 = {.tag = 49, .level = 2, .buff = buff4, .size = 32};
   pthread_create(&tid3, NULL, receive_message, (void *) &args4);

   sleep(2);
   exchange_args args5 = {.tag = 49, .level = 2, .buff = "Echo", .size = strlen("Echo")};
   pthread_create(&tid4, NULL, send_message, (void *) &args5);

   exchange_args args6 = {.tag = 89, .level = 30, .buff = "Lost echo", .size = strlen("Lost echo")};
